...
import { changes as incompleteEmployerChanges, id as incompleteEmployerId } from "./claimantInfo/incompleteEmployer";
...
const pageChangesMap = {
  ...
  [incompleteEmployerId]: incompleteEmployerChanges,
