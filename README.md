...
Both projects use Google Analytics to track page visits and specific UX events of interest. Both projects also use the [NJ Feedback Widget](https://github.com/newjersey/feedback-widget) to allow users to submit written feedback about the application. These can provide us with an idea of any sticking points in the application, or if our changes have an effect.
