...
describe("Claimant Personal Profile page", () => {
  ...
  function checkForm(addApt = false) {
    cy.mockASPX(URL);
    ...
    if (addApt) {
      cy.get('#ContentPlaceHolder1_ClaimantProfileTab_PERSONNEL_txtAddress2').type('Apartment 204');
    }
  ...
  describe("page with new JS", () => {
    ...
    it("tracks when personal address is long", () => {
      checkForm(true);
      cy.checkLogEvent("Long Personal Address Submitted", { addressLength: 46 });
    });
