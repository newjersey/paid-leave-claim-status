...
function CalendarControl() {
  ...
  function calendarDrawTable() {
    ...
    if (calendarControl.calendarType === "calendarWithMnthandYrOnly") {
        //BEGIN calendar with months and year 
        table = table + "<tr class='header'>";
        table = table + "  <td class='previous'><a href='javascript:changeCalendarControlYear(-1);'>&laquo;</a></td>";
        table = table + "  <td colspan='2' class='title'>" + currentYear + "</td>";
        ...
        for (var row = 0; row < months.length; row++) {
            ...
            for (var col = 0; col < 4; col++) {
                table = table + "<td  style='width: 46px; height: 34px; border: 1px solid;'><a class='" + css_class + "' href=\"javascript:setCalendarControlDate(" + currentYear + "," + (sum + 1) + "," + dayOfMonth + ")\">" + months[sum].substr(0, 3) + "</a></td>";
                sum = sum + 1;
            }
            row = sum;
            table = table + "</tr>";
        }
        //End Calendar with months and year.
    }
    else {
         //BEGIN calendar with  days months and year 
            table = table + "<tr class='header'>";
            ...
            //End calendar with  days months and year 
    } 
  ...
  this.calendarType = "default_calendar";
}

var calendarControl = new CalendarControl();

function showCalendarControl(textField, calendarType) {

    // textField.onblur = hideCalendarControl;
    calendarControl.calendarType = calendarType || "default_calendar";
